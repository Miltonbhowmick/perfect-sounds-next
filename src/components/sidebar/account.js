      ...
      <ul className="flex flex-col">
        ...
        >
          ...
          >
            ...
            <h5 className="text-primaryText">Profile</h5>
          </Link>
        </li>
        <li
          className={`${
            activeSidebar === 2 ? "bg-gradientRight" : ""
          } rounded-lg`}
        >
          <Link
          ...
          >
            ...
            <h5 className="text-primaryText">Favorites</h5>
          </Link>
        </li>
        <li
          className={`${
            activeSidebar === 3 ? "bg-gradientRight" : ""
          }  rounded-lg`}
        >
          <Link
          ...
          >
            ...
            <h5 className="text-primaryText">Downloads</h5>
          </Link>
        </li>
        <li
          className={`${
            activeSidebar === 4 ? "bg-gradientRight" : ""
          } rounded-lg`}
        >
          <Link
          ...
          >
            ...
            <h5 className="text-primaryText">Billing & Invoice</h5>
          </Link>
        </li>
      </ul>
    </div>
