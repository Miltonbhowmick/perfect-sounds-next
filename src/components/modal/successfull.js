...
const SuccessfullModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-x-hidden flex justify-center items-center bg-primaryBg">
      ...
      >
        <a className="p-auto md:p-1 absolute top-[8px] right-[8px]  md:top-[30px] md:right-[30px] border-gradientLeft border rounded-full">
          <svg
        ...
        <div className="flex flex-col items-center gap-5 md:gap-6 lg:gap-10">
          ...
          <ButtonGradiend className="py-2 md:py-3 rounded-md w-full" gradient>
