        ...
        <div className="flex flex-col lg:flex-row gap-3 justify-between items-center py-2 lg:py-4 px-6">
          ...
          <div className="w-full basis-auto lg:basis-[60%] shrink flex gap-2 md:gap-8 justify-start items-center">
            <div className="flex gap-1 justify-between items-center">
              <SkipPreviousIcon className="w-[18px] h-[18px] md:w-[60px] md:h-[60px] text-primaryText" />
              <ButtonMediaPlay
              ...
              />
              <SkipNextIcon className="w-[18px] h-[18px] md:w-[60px] md:h-[60px] text-primaryText" />
              <button className="w-max px-1 md:px-4 h-[24px] md:h-[45px] flex gap-1 items-center rounded-full border border-primaryText">
                <PlayArrowIcon className="text-primaryText text-small-xs md:text-paragraph-md" />
          ...
          <div className="border-t border-[#4F4F4F] w-full basis-auto lg:basis-[35%] pt-2 lg:py-auto flex gap-3 justify-between items-center">
